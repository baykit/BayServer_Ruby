        ...
        class PharosRuntime
          ...
          def ub_write_impl(str_addr, length)
            ...
            begin
              ...
              # unknown up front; BayServer's H1InboundHandler picks
              # Transfer-Encoding: chunked for HTTP/1.1 keep-alive
              # responses without a Content-Length, so keep-alive stays
              # functional.
